...
for temporal_w=down_w:-1:target_w
    ...
    [target,target2source,source2target]=my_search_and_vote(down_source,initial_target,niters,patch_R,patch_C,[],[]);
end
...
for i=1:numScales
    ...
    [ref_target,target2source,source2target]=my_search_and_vote(S_init,T_init,niters,patch_R,patch_C,[],[]);
    disp(i);
end
...
[final_output,target2source,source2target]=my_search_and_vote(image,ref_target,niters,patch_R,patch_C,[],[]);
