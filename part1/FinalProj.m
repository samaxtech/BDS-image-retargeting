...
for temporal_w=down_w:-1:target_w
    ...
    [target,target2source,source2target]=search_vote_func(down_source,initial_target,10);
end
...
for i=1:numScales
    ...
    [ref_target,target2source,source2target]=search_vote_func(S_init,T_init,10);
    disp(i);
end
...
[final_output,target2source,source2target]=search_vote_func(image,ref_target,10);
